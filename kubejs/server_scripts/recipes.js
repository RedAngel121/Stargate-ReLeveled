...
ServerEvents.recipes(event => {
  ...
  // COMPOSTS
  event.shaped(Blocks.COMPOST_MULCH.getIdentifier(), ["ded", "mfb", "dsd"], {
    d: "#minecraft:dirt",
  ...
  event.shaped(Blocks.COMPOST_FLORAL.getIdentifier(), ["roy", "mmm", "gbp"], {
