ServerEvents.recipes(event => {
    ...
    "sgcommunity_pack:isotopic_decay_oscillator_photomask",
    ...
    "sgcommunity_pack:isotopic_decay_oscillator_photomask",
    stagedWaferOutput(17, "Step 17: Inject Uranium Hexafluoride"),
    )

    event.custom({
        type: "mekanism:injecting",
        item_input: stagedWaferInput(17, "Step 17: Inject Uranium Hexafluoride"),
        chemical_input: {
